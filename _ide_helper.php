...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function track($ip, $full = false)
        {
                        /** @var \Salem\Tracker\Track $instance */
                        return $instance->track($ip, $full);
        }
                    /**
         ...
         * @static 
         */ 
        public static function trackedBefore($ip)
        {
                        /** @var \Salem\Tracker\Track $instance */
                        return $instance->trackedBefore($ip);
        }
                    /**
         * Get Bast of master data.
         *
         * @param integer $numbers Numbers of the best master data (default 10).
         * @return \Salem\Tracker\data return collection.
         * @static 
         */ 
        public static function getBestMaster($compare = 'country_name', $numbers = 10)
        {
                        /** @var \Salem\Tracker\Track $instance */
                        return $instance->getBestMaster($compare, $numbers);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getBestDetails($compare = 'browser', $numbers = 10)
        {
                        /** @var \Salem\Tracker\Track $instance */
                        return $instance->getBestDetails($compare, $numbers);
        }
                    /**
         * Get Bast.
         *
         * @param integer $numbers Numbers of the best country that will be returned (default 10).
         * @return \Salem\Tracker\data return collection of best countries.
         * @static 
         */ 
        public static function getBest($compare = 'country_name', $numbers = 10)
        {
                        /** @var \Salem\Tracker\Track $instance */
                        return $instance->getBest($compare, $numbers);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getPaginatedTracking($paginate = 20, $full = false)
        {
                        /** @var \Salem\Tracker\Track $instance */
                        return $instance->getPaginatedTracking($paginate, $full);
        }
                    /**
         * Get Track by id.
         *
         ...
         * @static 
         */ 
        public static function getTracking($id, $full = false)
        {
                        /** @var \Salem\Tracker\Track $instance */
                        return $instance->getTracking($id, $full);
        }
                    /**
         * Get Track by ip.
         *
         ...
         * @static 
         */ 
        public static function getTrackingByIp($ip, $full = false)
        {
                        /** @var \Salem\Tracker\Track $instance */
                        return $instance->getTrackingByIp($ip, $full);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getTrackingPaginatedByIp($ip, $paginate = 20, $full = false)
        {
                        /** @var \Salem\Tracker\Track $instance */
                        return $instance->getTrackingPaginatedByIp($ip, $paginate, $full);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getLastIpVisit($ip, $full = false)
        {
                        /** @var \Salem\Tracker\Track $instance */
                        return $instance->getLastIpVisit($ip, $full);
        }
                    /**
         * Send Ajax Request.
         *
...
namespace  { 
            ...
            class Tracker extends \Salem\Tracker\Facades\Tracker {}
